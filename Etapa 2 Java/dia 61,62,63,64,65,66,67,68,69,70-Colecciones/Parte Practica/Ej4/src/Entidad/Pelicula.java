...
public class Pelicula {
    ...
    public String toString() {
        return "Pelicula{" + "titulo=" + titulo + ", director=" + director + ", duracionEnHoras=" + duracionEnHoras + '}';
    }
    ...
    public static Comparator<Pelicula> compararDuracion=new Comparator<Pelicula>(){
        ...
        public int compare(Pelicula p1,Pelicula p2){
            return p2.getDuracionEnHoras().compareTo(p1.getDuracionEnHoras());
        }
    };
    ...
    public static Comparator<Pelicula> compararDuracion2=new Comparator<Pelicula>(){
        @Override
        public int compare(Pelicula p1,Pelicula p2){
            return p1.getDuracionEnHoras().compareTo(p2.getDuracionEnHoras());
        }
    };
