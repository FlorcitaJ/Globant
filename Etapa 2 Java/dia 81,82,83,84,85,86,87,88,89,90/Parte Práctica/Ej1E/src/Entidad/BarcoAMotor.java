...
public class BarcoAMotor extends Barco{
    protected Integer potenciaEnCV;
    ...
    public void crearBarco() {
        ...
        this.potenciaEnCV=leer.nextInt();
    }
    
    @Override
    public Integer calculoDeModulo() {
        Integer modulo=super.calculoDeModulo()+this.potenciaEnCV;
        return modulo;
    }

    @Override
    public String toString() {
        return super.toString()+" potencia en CV= "+potenciaEnCV+'}';
    }
